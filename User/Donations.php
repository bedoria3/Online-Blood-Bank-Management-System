                    ...
                    <div class="form_holder"
                        ...
                        <form action="Donations.php" method="post" onsubmit="return validateForm()">
                            <div class="for" style="width: 480px;">
                                ...
                                <option value="Cebu Doctor University Hospital">Cebu Doctor University Hospital</option>
                                <option value="Vicente Sotto Memorial Medical Center">Vicente Sotto Memorial Medical Center</option>
                                <option value="North General Hospital">North General Hospital</option>
                                <option value="South General Hospital">South General Hospital</option>
                                <option value="Sacred Heart Hospital">Sacred Heart Hospital</option>
