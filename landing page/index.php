...
<header class="header">
    ...
    <nav class="navbar">
        <ul>
            ...
            <li><a href="../User/Log_As.php">Login</a>
            <li><a href="../User/register.php">Sign Up</a>
            </li>
        </ul>
    </nav>
    ...
    <div class="container">
        <div class="about-details">
            ...
            <div class="cards">
                ...
                <div class="card2">
                    <h1>Who we are?</h1>
                    <p>We are a community that helps in managing various blood bank operations effectively. In addition, we help  to automate blood donation process, encourage blood donors to donate, and help people find blood donors in times of need."</p>
                </div>
                <div class="card3">
                    <h1>What we value?</h1>
                    <p>"We value life. Saving lives of people by providing a system that easy to access if they need blood and being the best blood center."</p>
                </div>
