...
<body>
  ...
  <section class="home-section" >
    ...
    <div class="forms" style="margin-left:20%">
     ...
     <a   href="../manageadmin.php" class="button">Back</a>

</div>


    <div id= "sample">
  <form action = "addadminsuccess.php" method = "post" style= "margin-left: 30%;">
    <label for="fname">First Name</label>
    <input type="text" id="btype" name="firstname" placeholder="Input your firstname..." required>
    <label for="fname">Last Name</label>
    <input type="text" id="btype" name="lastname" placeholder="Input your lastname..." required>
    <label for="fname">Username</label>
    <input type="text" id="btype" name="username" placeholder="Input your username..." required>
    <label for="fname">Email</label>
    <input type="text" id="btype" name="email" placeholder="Input your email..." required>
    <label for="fname">Address</label>
    <input type="text" id="btype" name="address" placeholder="Input your address..." required>
    <label for="fname">Password</label>
    <input type="text" id="btype" name="password" placeholder="Input your password..." required>
