...
<body>
  ...
  <section class="home-section" >
    ...
    <div id= "sample">
  <form action = "addcampssuccess.php" method = "post" style= "margin-left: 30%;">
    <label for="fname">Hospital</label>
    <input type="text" id="btype" name="hospital" placeholder="Input the hospital..." required>
    <label for="fname">Address</label>
    <input type="text" id="btype" name="address" placeholder="Input the address..." required>
    <label for="fname">Contact</label>
    <input type="text" id="btype" name="contact" placeholder="Input the contact..." required>
    <label for="fname">Email</label>
    <input type="text" id="btype" name="email" placeholder="Input the email..." required>
