  ...
  <section class="home-section" >
    <nav style= "background-color:red;">
      <div class="sidebar-button">
        ...
        <span class="dashboard" id="ok">Add Camps</span>
      </div>
    </nav> <br><br> <br> <br><br>
...
$qry = "insert into admin_file (firstname,lastname,username,email,password) values ('$firstname','$lastname','$username', '$email', '$password')";
