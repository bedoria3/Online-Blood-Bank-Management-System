  ...
  <section class="home-section" >
    ...
    <div class="form">
        <form class="email-form">
            ...
            <a href="#" class="button">Add Blood Group</a>
        </form>
    </div> <br><br><br><br>
...
<thead>
  ...
  <tbody>
    <?php
    foreach($results as $manage_blood){
      echo '<tr>';
      echo '<td>',$manage_blood['firstname']. '' .$manage_blood['lastname']. '</td>';
      echo '<td>',$manage_blood['city']. '</td>';
      echo "<td><a href=edituser.php? id= $manage_blood[id]'>Edit</a>&nbsp;&nbsp;<a href = 'deleteuser.php? id= $user[id]'>Delete</a></td>";
      echo '</tr>';
    }
    ?>
