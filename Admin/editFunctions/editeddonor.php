  ...
  <div class="sidebar" style="  background-color: #DDD7D7;">
    <div class="logo-details">
      ...
      <ul class="nav-links" >
        ...
        <li>
          <a href="../managedonor.html"  class="active">
  ...
  <section class="home-section" >
    <nav style= "background-color:red;">
      <div class="sidebar-button">
        ...
        <span class="dashboard" id="ok"> Edit Donor</span>
      </div>
...
$id=$_POST['id'];
//update query
$qry = "update donations_file set donor_name='$name', gender='$gender', age='$age', mobile_phone='$contact', address='$address', blood_type='$bloodtype', blood_quantity='$bloodqty' where donation_ID='$id'";
